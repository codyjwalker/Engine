...
public class TerrainShader extends ShaderProgram {
	...
	private int location_transformation_matrix, location_projection_matrix,
			location_view_matrix, location_light_position[],
			location_light_color[], location_attenuation[],
			location_shine_damper, location_reflectivity, location_sky_color,
			location_background_texture, location_r_texture, location_g_texture,
			location_b_texture, location_blend_map;
