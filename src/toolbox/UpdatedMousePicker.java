...
public class UpdatedMousePicker {
	...
	public UpdatedMousePicker(Camera cam, Matrix4f projection,
			Terrain terrain) {
		camera = cam;
	...
	private Vector3f calculateMouseRay() {
		...
		Vector2f normalizedCoords = getNormalisedDeviceCoordinates(mouseX,
				mouseY);
	...
	private Vector2f getNormalisedDeviceCoordinates(float mouseX,
			float mouseY) {
